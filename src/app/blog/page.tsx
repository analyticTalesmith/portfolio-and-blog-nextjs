...
export default function Home() {
  return (
    <Container>
        ...
        <div className="space-y-2">
          <p>
            <span className="text-transparent font-bold bg-clip-text bg-gradient-to-tr to-secondary from-primary">
              Where data comes to life through personal insights, practical advice, and tutorials
            </span>
            . This blog is my space to share my journey with data, business, and
            people analytics, offering deep dives into topics like data science,
            I/O psychology, digital marketing, business strategy, and other topics.
          </p>
          <p>
      ...
      < HorizontalRule outerClassName="mt-16"/>
      <h2>Recent Posts</h2>
      <div className="py-8">
        <Pagination>
          <PaginationContent>
